...
const QUESTIONS = [
    ...
    },
    {
        ...
        answer: '멤버십에 넷플릭스 키즈 환경이 포함되어 있어 자녀가 자기만의 공간에서 가족용 시리즈와 영화를 즐기는 동안 부모가 이를 관리할 수 있습니다. 키즈 프로필과 더불어 PIN 번호를 이용한 자녀 보호 기능도 있어, 자녀가 시청할 수 있는 콘텐츠의 관람등급을 제한하고 자녀의 시청을 원치 않는 특정 작품을 차단할 수도 있습니다.',
        collapsed: false,
    },
];
...
const QuestionSection = () => {
    ...
    return questions.map((question) => (
        <React.Fragment key={question.questionId}>
            ...
            {question.collapsed && <Answer answer={question.answer} />}
        </React.Fragment>
    ));
};
